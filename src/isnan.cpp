...
int main(int argc, char *argv[])
{
    ...
    //Description
    string descr;
    descr += "<cmath> function, isnan.\n";
    descr += "\n";
    descr += "Checks each element of X if is NaN.\n";
    descr += "For complex input, output is true if either real or imag part is NaN.\n";
    ...
    if (i1.T==1)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](float x){return isnan(x);}); }
    ...
    else if (i1.T==2)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](double x){return isnan(x);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==3)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](long double x){return isnan(x);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==101)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](complex<float> x){return (isnan(x.real()) || isnan(x.imag()));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==102)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](complex<double> x){return (isnan(x.real()) || isnan(x.imag()));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==103)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](complex<long double> x){return (isnan(x.real()) || isnan(x.imag()));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
