...
int main(int argc, char *argv[])
{
    ...
    //Description
    string descr;
    descr += "<numeric> function, gcd.\n";
    descr += "\n";
    descr += "Gets greatest common divisor of corresponding elements of X1 and X2.\n";
    ...
    if (o1.iscolmajor())
    {
        //try { GS1 = gslice(0,{o1.S,o1.C,o1.R},{si1*i1.R*i1.C,ci1*i1.R,ri1}); }
        ...
        //try { GS2 = gslice(0,{o1.S,o1.C,o1.R},{si2*i2.R*i2.C,ci2*i2.R,ri2}); }
    ...
    {
        //try { GS1 = gslice(0,{o1.R,o1.C,o1.S},{ri1*i1.S*i1.C,ci1*i1.S,si1}); }
        try { GS1 = gslice(0,{o1.R,o1.C,o1.S,o1.H},{ri1*i1.H*i1.S*i1.C,ci1*i1.H*i1.S,si1*i1.H,hi1}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem making gslice for input 1" << endl; return 1; }
        //try { GS2 = gslice(0,{o1.R,o1.C,o1.S},{ri2*i2.S*i2.C,ci2*i2.S,si2}); }
    ...
    if (i1.T==8)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<int8_t>(X2[GS2])),begin(Y),[](int8_t x1,int8_t x2){return gcd(x1,x2);}); }
    ...
    else if (i1.T==9)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<uint8_t>(X2[GS2])),begin(Y),[](uint8_t x1,uint8_t x2){return gcd(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==16)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<int16_t>(X2[GS2])),begin(Y),[](int16_t x1,int16_t x2){return gcd(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==17)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<uint16_t>(X2[GS2])),begin(Y),[](uint16_t x1,uint16_t x2){return gcd(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==32)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<int32_t>(X2[GS2])),begin(Y),[](int32_t x1,int32_t x2){return gcd(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==33)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<uint32_t>(X2[GS2])),begin(Y),[](uint32_t x1,uint32_t x2){return gcd(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==64)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<int64_t>(X2[GS2])),begin(Y),[](int64_t x1,int64_t x2){return gcd(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==65)
    {
        ...
        try { transform (begin(Y),end(Y),begin(valarray<uint64_t>(X2[GS2])),begin(Y),[](uint64_t x1,uint64_t x2){return gcd(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
