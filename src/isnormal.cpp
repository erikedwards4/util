...
int main(int argc, char *argv[])
{
    ...
    else if (i1.T==2)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](double x){return isnormal(x);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==3)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](long double x){return isnormal(x);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==102u)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](complex<double> x){return (isnormal(x.real()) && isnormal(x.imag()));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==103u)
    {
        ...
        try { transform(begin(X),end(X),begin(Y),[](complex<long double> x){return (isnormal(x.real()) && isnormal(x.imag()));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem during call to function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
