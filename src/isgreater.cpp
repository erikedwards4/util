...
int main(int argc, char *argv[])
{
    ...
    //Description
    string descr;
    descr += "<cmath> function, isgreater.\n";
    descr += "\n";
    ...
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ isgreater X1 X2 -o Y \n";
    descr += "$ isgreater X1 X2 > Y \n";
    descr += "$ cat X2 | isgreater X1 > Y \n";
    ...
    if (i1.T==1)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<float>(X2[GS2])),begin(Y),[](float x1,float x2){return isgreater(x1,x2);}); }
    ...
    else if (i1.T==2)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<double>(X2[GS2])),begin(Y),[](double x1,double x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==3)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<long double>(X2[GS2])),begin(Y),[](long double x1,long double x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==8)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<int8_t>(X2[GS2])),begin(Y),[](int8_t x1,int8_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==9)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<uint8_t>(X2[GS2])),begin(Y),[](uint8_t x1,uint8_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==16)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<int16_t>(X2[GS2])),begin(Y),[](int16_t x1,int16_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==17)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<uint16_t>(X2[GS2])),begin(Y),[](uint16_t x1,uint16_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==32)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<int32_t>(X2[GS2])),begin(Y),[](int32_t x1,int32_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==33)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<uint32_t>(X2[GS2])),begin(Y),[](uint32_t x1,uint32_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==64)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<int64_t>(X2[GS2])),begin(Y),[](int64_t x1,int64_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==65)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<uint64_t>(X2[GS2])),begin(Y),[](uint64_t x1,uint64_t x2){return isgreater(x1,x2);}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==101)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<complex<float>>(X2[GS2])),begin(Y),[](complex<float> x1,complex<float> x2){return isgreater(abs(x1),abs(x2));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==102)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<complex<double>>(X2[GS2])),begin(Y),[](complex<double> x1,complex<double> x2){return isgreater(abs(x1),abs(x2));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
    ...
    else if (i1.T==103)
    {
        ...
        try { transform (begin(X1),end(X1),begin(valarray<complex<long double>>(X2[GS2])),begin(Y),[](complex<long double> x1,complex<long double> x2){return isgreater(abs(x1),abs(x2));}); }
        catch (...) { cerr << progstr+": " << __LINE__ << errstr << "problem applying function" << endl; return 1; }
        if (Y.size()!=o1.N()) { cerr << progstr+": " << __LINE__ << errstr << "unexpected output size" << endl; return 1; }
        if (wo1)
        {
