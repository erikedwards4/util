...
int main(int argc, char *argv[])
{
    ...
    //Description
    string descr;
    descr += "valarray class member function, X.shift(cnt).\n";
    descr += "\n";
    descr += "Shifts elements by cnt elements, replacing with 0 at edge.\n";
    descr += "Postive cnt shifts up, so that X[1] -> Y[0].\n";
    descr += "\n";
    descr += "Indices are in global (flattened) order.\n";
    descr += "For col-major file format, this shifts along cols.\n";
    descr += "For row-major file format, this shifts along rows.\n";
    descr += "\n";
    descr += "Output (Y) has the same size, data type and file format as X.\n";
    descr += "\n";
    descr += "Use -n (--count) to specify the num elements to shift by [default=0].\n";
    descr += "\n";
    descr += "Examples:\n";
    descr += "$ shift -n3 X -o Y \n";
    descr += "$ shift -n3 X > Y \n";
    descr += "$ cat X | shift -n3 > Y \n";
    descr += "$ cat X | shift -n-3 > Y \n";
    ...
    void *argtable[] = {a_fi, a_cnt, a_fo, a_help, a_end};
